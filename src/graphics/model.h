...
public:
	...
	/// \param amount a vec3 describing the direction and amount of movement
	///
	void translate(glm::vec3 amount);
	///
	/// Gets the vec3 that describes the rotation of this Model
	/// \return a vec3 that describes the rotation of this Model
	///
	glm::vec3 getRotationOnAxes();
	///
	/// Rotates the Model by the rotation values specified in the vec3
