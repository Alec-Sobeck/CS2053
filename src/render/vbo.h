...
///
/// VBO defines an immutable class that takes a ModelData object, constructs a Vertex Buffer Object,
/// and then allows it to be drawn with a call to draw()
///
class VBO
{
private:
	// @TODO -- reinstate the const modifiers for all parameters
