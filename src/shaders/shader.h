...
public:
	...
	void glUniformMatrix2(std::string attributeName, gl::GLboolean transpose, glm::mat2);
	void glUniformMatrix3(std::string attributeName, gl::GLboolean transpose, glm::mat3);
	void glUniformMatrix4(std::string attributeName, gl::GLboolean transpose, glm::mat4);
