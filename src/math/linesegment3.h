...
/// 
/// LineSegment3 represents a line segment in 3-Dimensional space. A line segment is a line that has
/// 2 defined end points and will not continue forever.
/// 
class LineSegment3 : public ILineVariant
{
public:
	...
	int getDimension();
	///
	/// Gets the length of the LineSegment, by converting the LineSegment to a glm::vec3 and calling the length() function.
