...
public:
	...
	/// \return a bool representing if the line variant and plane intersect;  false if the line variant is parallel to the plane.
	///
	...
	/// \return a vec4 representing the plane
	///
