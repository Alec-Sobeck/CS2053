...
{
    return static_cast<gl40::GLenum>(glbinding::Binding::CheckFramebufferStatus(target));
}
...
{
    return static_cast<gl40::GLenum>(glbinding::Binding::ClientWaitSync(sync, flags, timeout));
}
...
{
    return static_cast<gl40::GLenum>(glbinding::Binding::GetError());
}
