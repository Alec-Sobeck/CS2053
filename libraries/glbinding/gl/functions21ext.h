...
{
    return static_cast<gl21ext::GLenum>(glbinding::Binding::CheckFramebufferStatus(target));
}

inline GLenum glCheckFramebufferStatusEXT(GLenum target)
{
    return static_cast<gl21ext::GLenum>(glbinding::Binding::CheckFramebufferStatusEXT(target));
}

inline GLenum glCheckNamedFramebufferStatus(GLuint framebuffer, GLenum target)
{
    return static_cast<gl21ext::GLenum>(glbinding::Binding::CheckNamedFramebufferStatus(framebuffer, target));
}

inline GLenum glCheckNamedFramebufferStatusEXT(GLuint framebuffer, GLenum target)
{
    return static_cast<gl21ext::GLenum>(glbinding::Binding::CheckNamedFramebufferStatusEXT(framebuffer, target));
}
...
{
    return static_cast<gl21ext::GLenum>(glbinding::Binding::ClientWaitSync(sync, flags, timeout));
}
...
{
    return static_cast<gl21ext::GLenum>(glbinding::Binding::GetGraphicsResetStatus());
}

inline GLenum glGetGraphicsResetStatusARB()
{
    return static_cast<gl21ext::GLenum>(glbinding::Binding::GetGraphicsResetStatusARB());
}
...
{
    return static_cast<gl21ext::GLenum>(glbinding::Binding::ObjectPurgeableAPPLE(objectType, name, option));
}

inline GLenum glObjectUnpurgeableAPPLE(GLenum objectType, GLuint name, GLenum option)
{
    return static_cast<gl21ext::GLenum>(glbinding::Binding::ObjectUnpurgeableAPPLE(objectType, name, option));
}
...
{
    return static_cast<gl21ext::GLenum>(glbinding::Binding::PathGlyphIndexArrayNV(firstPathName, fontTarget, fontName, fontStyle, firstGlyphIndex, numGlyphs, pathParameterTemplate, emScale));
}
...
{
    return static_cast<gl21ext::GLenum>(glbinding::Binding::PathGlyphIndexRangeNV(fontTarget, fontName, fontStyle, pathParameterTemplate, emScale, baseAndCount));
}
...
{
    return static_cast<gl21ext::GLenum>(glbinding::Binding::PathMemoryGlyphIndexArrayNV(firstPathName, fontTarget, fontSize, fontData, faceIndex, firstGlyphIndex, numGlyphs, pathParameterTemplate, emScale));
}
...
{
    return static_cast<gl21ext::GLbitfield>(glbinding::Binding::QueryMatrixxOES(mantissa, exponent));
}
...
{
    return static_cast<gl21ext::GLenum>(glbinding::Binding::VideoCaptureNV(video_capture_slot, sequence_num, capture_time));
}
