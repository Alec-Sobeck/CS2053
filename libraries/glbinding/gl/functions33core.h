...
{
    return static_cast<gl33core::GLenum>(glbinding::Binding::CheckFramebufferStatus(target));
}
...
{
    return static_cast<gl33core::GLenum>(glbinding::Binding::ClientWaitSync(sync, flags, timeout));
}
...
{
    return static_cast<gl33core::GLenum>(glbinding::Binding::GetError());
}
