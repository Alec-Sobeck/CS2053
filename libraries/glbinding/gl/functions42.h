...
{
    return static_cast<gl42::GLenum>(glbinding::Binding::CheckFramebufferStatus(target));
}
...
{
    return static_cast<gl42::GLenum>(glbinding::Binding::ClientWaitSync(sync, flags, timeout));
}
...
{
    return static_cast<gl42::GLenum>(glbinding::Binding::GetError());
}
